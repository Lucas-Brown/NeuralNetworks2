...
public class NetworkTools {
    ...
    public static void multiplyArray(double[] arr, double multiplier) {
    	for(int i = 0; i < arr.length; i++) {
    		arr[i] *= multiplier;
    	}
    }
    
    public static void push(double[][] arr, double[] value) {
    ...
    public static void printDeg2Array(double[][] arr){
        for(double[] a: arr){
            System.out.println(Arrays.toString(a));
        }
    }

    public static void printDeg3Array(double[][][] arr){
        for(double[][] a: arr){
            for(double[] b: a){
